...
const BallMP = ({
  ...
  const scaleFactor = Math.min(window.innerWidth / 1920, window.innerHeight / 1080) * 1.2;
  ...
  }, [x, y, dx, dy, leftPaddleY, rightPaddleY, setLeftScore, setRightScore]);
